...
public class TransactionListAdapter extends ArrayAdapter<String> {
	...
	public TransactionListAdapter(Context context, int layoutid	, ArrayList<String> obj) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.transaction = (TextView) convertView.findViewById(android.R.id.text1);
